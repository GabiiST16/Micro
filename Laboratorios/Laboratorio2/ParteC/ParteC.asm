...
; ------------------------------------------------------------------------------
; 2. CÍRCULO (ALTA DEFINICIÓN - 64 CORTES - DIÁMETRO ~100 MM)
...
; ------------------------------------------------------------------------------
; 3. ESTRELLA DE 5 PUNTAS (ALTA DEFINICIÓN BRESENHAM)
; Silueta continua de 10 aristas rectas con más de 100 micro-cortes entrelazados
; y simetría bilateral geométrica exacta
...
DIBUJAR_TODAS:
    ...
    ; 2. ESQUINA SUPERIOR IZQUIERDA: CIRCULO (X=80, Y=15)
    ; Desplazamos 60 pasos a la izquierda con lapiz arriba
    MOVER_IZ 60
    rcall DELAY_500MS
    rcall DIBUJAR_CIRCULO
    rcall DELAY_500MS

    ; 3. ESQUINA INFERIOR IZQUIERDA: PENTAGRAMA (X=80, Y=65)
    ; Desplazamos 50 pasos hacia abajo con lapiz arriba
    MOVER_AB 50
    rcall DELAY_500MS
    rcall DIBUJAR_PENTAGRAMA
    rcall DELAY_500MS

    ; 4. ESQUINA INFERIOR DERECHA: CASITA (X=20, Y=65)
    ; Desplazamos 60 pasos a la derecha con lapiz arriba
    MOVER_DER 60
    rcall DELAY_500MS
    rcall DIBUJAR_LIBRE_CASA
    rcall DELAY_500MS

    ; 5. CENTRO DE LA HOJA: POKEMON CUBONE (#104) (X=50, Y=40)
    ; Desplazamos 30 pasos a la izquierda y 25 pasos hacia arriba
    MOVER_IZ 30
    MOVER_AR 25
    rcall DELAY_500MS
    rcall DIBUJAR_CUBONE

    ; Retornar desde el centro a Home (0, 0)
    rcall RETORNAR_DEL_CENTRO
...
; ==============================================================================
; MODO DE CONTROL Y EDICION PERSONALIZADO
; ==============================================================================
...
; ==============================================================================
; TABLAS LOOK-UP TABLE (LUT) DE FIGURAS EN ALTA DEFINICIÓN (.cseg)
; Formato por entrada: (Comando/Máscara, Duración de pasos)
; Comandos especiales: 0xFF, 0x01 (Bajar lápiz)
;                      0xFF, 0x02 (Subir lápiz)
